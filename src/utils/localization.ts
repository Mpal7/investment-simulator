...
export const translations = {
    it: {
        ...
        result: {
            ...
            opportunityCostSubtext: 'Incidenza costi su profitto',
        ...
        summary: {
            ...
            stampDutyText: 'L\'imposta di bollo annuale (0,20%) ha ridotto il tuo capitale di ulteriori {stampDuty} nel corso del tempo.',
    ...
    en: {
        ...
        result: {
            ...
            opportunityCostSubtext: 'Impact of fees on profit',
        ...
        summary: {
            ...
            stampDutyText: 'The annual stamp duty (0.20%) reduced your capital by an additional {stampDuty} over time.',
            netProfit: 'After Tax:',
